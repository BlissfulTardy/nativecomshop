...
- Expo CLI (if you do not have it installed, run `npm install -g expo-cli`)
...
For more detailed documentation and usage of individual libraries, please refer to their respective official documentation.
